...
print(remove_duplicate("azxxzy"))  # ay
print(remove_duplicate("abbaca"))  # ca
print(remove_duplicate("geeksforgeeg"))  # gksfor
print(remove_duplicate("caaabbbaacdddd"))  # none
print(remove_duplicate("acaaabbbacdddd"))  # acac
